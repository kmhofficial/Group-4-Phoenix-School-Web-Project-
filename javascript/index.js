...
var iframebox = document.getElementById('iframeemailbox');
...
function pswcheck() {
    if(document.getElementById('fname').value =="" ||document.getElementById('fname').value == null || document.getElementById('lname').value =="" 
    ...
    if(/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/g.test
    ...
    if(document.getElementById('checkterms').checked == false){
        document.getElementById('checkerror').innerHTML = "Please check this box if you want to proceed";
        document.getElementById('checkerror').style.display ="block";
        document.getElementById('checkerror').style.color ="#FF0000";
        return false;
    }else{
